...
godoc: https://pkg.go.dev/github.com/sourcenetwork/graphql-go

### Getting Started

To install the library, run:
```bash
go get github.com/sourcenetwork/graphql-go
```
...
```
For more complex examples, refer to the [examples/](https://github.com/sourcenetwork/graphql-go/tree/master/examples/) directory and [graphql_test.go](https://github.com/sourcenetwork/graphql-go/blob/master/graphql_test.go).

### Third Party Libraries
| Name          | Author        | Description  |
|:-------------:|:-------------:|:------------:|
| [graphql-go-handler](https://github.com/sourcenetwork/graphql-go-go-handler) | [Hafiz Ismail](https://github.com/sogko) | Middleware to handle GraphQL queries through HTTP requests. |
| [graphql-relay-go](https://github.com/sourcenetwork/graphql-go-relay-go) | [Hafiz Ismail](https://github.com/sogko) | Lib to construct a graphql-go server supporting react-relay. |
